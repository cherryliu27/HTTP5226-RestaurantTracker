...
namespace RestaurantTracker.Controllers
{
    public class BranchController : Controller
    {
        ...
        static BranchController()
        {
            ...
            client.BaseAddress = new Uri("https://localhost:44355/api/branchdata/");
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            //curl https://localhost:44355/api/branchdata/findbranch/{id}
        ...
        public ActionResult Add(int id)
        {
            ...
            string url = "https://localhost:44355/api/restaurantdata/findrestaurant/" + id;
            HttpResponseMessage response = client.GetAsync(url).Result;
